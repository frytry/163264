% function [VOP] =voptestNITScombine_fsize(speech,WL,OL)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%         
          ...
          [speech,fs]=audioread('D:\7 sem comb\Documents\project\sir\DR1\FCJF0\SA1.wav');
          data=speech;
...
%%%%%%--------------------------------------------------------------------------
% LPFL=WL;LPOLN=OL; %modified by niru
